...
describe('mymoneydapp', () => {
    ...
    //on the environment (anchor.Provider.local()).
    const provider = anchor.Provider.local();
    anchor.setProvider(provider);
    //* the program is an abstraction that combines the Provider, idl, and 
    //the programID (which is generated when the program is built) and 
    //allows us to call RPC methods against our program.
